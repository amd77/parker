...
urlpatterns = [
    ...
    url(r'^estadisticas/(?P<year>\d+)/(?P<month>\d+)/(?P<day>\d+)/(?P<cuales>\w*)$', v.EntradaDayList.as_view(), name="estadisticas_day"),
    url(r'^estadisticas/(?P<year>\d+)/(?P<month>\d+)/(?P<cuales>\w*)$', v.EntradaMonthList.as_view(), name="estadisticas_month"),
